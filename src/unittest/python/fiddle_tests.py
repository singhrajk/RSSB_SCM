...
class FiddleTest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        print (constants.TEST_START  + self._testMethodName.replace(constants.UNDERSCORE, constants.SPACE))
    ...
    def test_5_Preacher_Export_Preacher_Details(self):
        try:
    ...
    def tearDown(self):
        print (constants.TEST_FINSIH  + self._testMethodName.replace(constants.UNDERSCORE, constants.SPACE))
